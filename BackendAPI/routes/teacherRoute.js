...
router.post('/fortech',async(req,res)=>{
    try{
...
router.get('/fornontech',async(req,res)=>{
    try{
        const data = await Teacher.find({},{_id:1,teacherBoard:1,teacherName:1,teacherSex:1,teacherAge:1,teacherDesignation:1,teacherAddress:1,teacherPhonenumber:1,teacherAssignedClasses:1,teacherBoard:1});
        if(data!=null){
